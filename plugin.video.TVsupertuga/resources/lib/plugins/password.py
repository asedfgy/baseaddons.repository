...
def showing(url):
	...
	TheCode = base64.b32decode(TheCode)
	input = ''
	keyboard = xbmc.Keyboard(input, '[COLOR red]Zona reservada para maiores de 18 anos! Voce tem mais de 18 anos?[/COLOR]')
	keyboard.doModal()
	...
	if input == TheCode: 
		...
		xml += "<dir>"\
			   "<title>[COLOR yellow]Incorrect Password  Password is available from\n [/COLOR]</title>"\
			   "<thumbnail>https://i72.servimg.com/u/f72/19/44/91/43/istock10.jpg</thumbnail>"\
			   "<summary>Zona reservada para maiores de 18 anos! Voce tem mais de 18 anos?Entre em contacto connosco atraves : FACEBOOK :https://www.facebook.com/TVsupertuga.pt/  E-MAIL :tvsupertuga@gmail.com</summary>"\
			   "</dir>"
	jenlist = JenList(xml)
