...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Stream TVsupertuga Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/script.module.stream.tvsupertuga.addon')
    ...
    try:
        curVersion = control.addon('script.module.streamtvsupertuga').getAddonInfo('version')
