...
class source:
    def __init__(self):
        ...
        self.base_link = 'https://bobmovies.mrunlock.trade' # 'https://bobmovies.mrunlock.trade' # https://mrunlock.bid/ # https://mrunlock.stream/ # http://gomov.download/ # MRUNLOCK.INFO
                ...
                if self.base_link in url:
                    ...
                    if cleantitle.get(title) in cleantitle.get(url):
                        ...
                        if cleantitle.get(title) in cleantitle.get(chktitle):
                            if year in chktitle:
                                url = url.replace('bobmovies.mrunlock.trade', 'bobmovies.net')
                                return url
            return
        except:
