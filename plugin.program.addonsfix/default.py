...
base='https://goo.gl/dt8Rfx'
ADDON=xbmcaddon.Addon(id='plugin.program.addonsfix')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR cyan]TV[/COLOR]-[COLOR red]supertuga[/COLOR] [COLOR White]Addons[/COLOR] [COLOR cyan]FIX[/COLOR]","[COLOR orange][B]Downloading[/B][/COLOR] ",'', '[COLOR yellow][B]Please Wait[/B][/COLOR]')
    ...
    time.sleep(2)
    dp.update(0,"", "[COLOR cyan][B]Extracting Zip Please Wait[/B][/COLOR]")
    print '======================================='
    print addonfolder
    print '======================================='
    extract.all(lib,addonfolder,dp)
    dialog = xbmcgui.Dialog()
    dialog.ok("[COLOR white][B]DOWNLOAD COMPLETE[/B][/COLOR]", 'Unfortunately the only way to get the new changes to stick is', 'to force close kodi. Click ok to force Kodi to close,', 'DO NOT use the quit/exit options in Kodi., If the Force close does not close for some reason please Restart Device or kill task manaully')
    killxbmc()
