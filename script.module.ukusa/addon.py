...
@plugin.route('/')
def root():
    categories = {"01": "[COLOR white][B]UK & USA[COLOR white] Channels[/B][/COLOR]",
                  "02": "[COLOR white][B]M[COLOR white]OVIES[/B][/COLOR]",
                  "03": "[COLOR white][B]M[COLOR white]USIC[/B][/COLOR]",
                  "04": "[COLOR white][B]N[COLOR white]EWS[/B][/COLOR]",
                  "05": "[COLOR white][B]S[COLOR white]PORTS[/B][/COLOR]",
                  "06": "[COLOR white][B]D[COLOR white]OCUMENTARY[/B][/COLOR]",
                  "07": "[COLOR white][B]K[COLOR white]IDS[/B][/COLOR]",}
    list_items = []
