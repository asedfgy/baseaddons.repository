...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.powertv/resources/ivue','Power TV.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.powertv/resources/ivue','plugin.video.powertv.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.powertv'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("Power TV","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.powertv/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.powertv/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("Power TV","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Power TV","Installing iVue TV Guide...",'', 'Please Wait')
